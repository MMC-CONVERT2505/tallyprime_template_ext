...
describe('TallyResponseParser', () => {
  ...
  describe('mapLedgers', () => {
    it('parses balances and AlterID, tolerating omitted tags', () => {
      const xml =
        '<ENVELOPE><BODY><DATA><COLLECTION>' +
        '<LEDGER><NAME>Cash</NAME><PARENT>Cash-in-Hand</PARENT>' +
        '<OPENINGBALANCE>1000.00</OPENINGBALANCE><CLOSINGBALANCE>-2500.50</CLOSINGBALANCE><ALTERID>42</ALTERID></LEDGER>' +
        '<LEDGER><NAME>Sales</NAME></LEDGER>' + // no parent/balances/alterid
        '</COLLECTION></DATA></BODY></ENVELOPE>';
